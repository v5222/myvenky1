...
import styles from "./billingFilters.module.scss";
    ...
    <>
      <div className={styles.container}>
        ...
        <div className={styles.wrapper}>
          ...
          >
            {data.map((i, index) => {
              return (
                <>
                  <Option title="bill_toid" value={i.bill_toid} key={index}>
                    {i.bill_toid}
                  </Option>
                </>
              );
        ...
        <div className={styles.wrapper}>
          ...
          <Select defaultValue="Transportation" className={styles.select}>
        ...
        <div className={styles.wrapper}>
          <div className={styles.title} style={{ color: "transparent" }}>
            Billing type
          </div>
          <Button
            type="primary"
