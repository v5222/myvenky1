...
class InvoicePrint extends React.Component {
  render() {
    ...
    return (
      <div>
        <div className={styles.reportType}>{details.taxsch}</div>
        <section className={styles.container}>
          ...
          <div className={styles.companyDetails}>
            ...
            <div className={styles.companyAddr}>{details.sellerlocation}</div>
          ...
          {InvoiceDetailsList[0].itemisservc === "N" ? (
            <div className={styles.companyDetails}>
              ...
              <div className={styles.companyAddr}>{details.displocation}</div>
              <div className={styles.companyAddr}>{details.disppincode}</div>
              <div className={styles.companyAddr}>
                State Code : {details.dispstcd}
              </div>
              <div className={styles.companyAddr}>GSTIN : </div>
              <div className={styles.companyAddr}>PAN :</div>
              <div className={styles.companyAddr}>UIN :</div>
            </div>
          ) : (
            ""
          ...
          <div className={styles.qrcode}>
            ...
            <div>
              ...
              <div> {details.irn.slice(24, 48)}</div>
              <div> {details.irn.slice(48)}</div>
            </div>
          </div>
        </section>
        <div
          ...
          <Row gutter={[10, 15]}>
            ...
            <Col span={12}>
              <div className={styles.invoiceNo1}>
                Original Document No : {details.refinvno}
              </div>
              <div className={styles.invoiceNo1}>
                Original Document Date : {details.refinvdt}
              </div>
            </Col>
            {/* <Col span={12} /> */}
          </Row>
          ...
          <Row gutter={[10, 15]}>
            ...
            <Col span={12}>
              <div className={styles.subcontainer}>
                ...
                <div className={styles.subheading1}>{details.shiplocation}</div>
          ...
          <Row gutter={[10, 15]}>
            ...
            <Col span={12}>
              <div className={styles.subcontainer}>
                ...
                <table style={{ margin: "0px 0px" }} id={styles.subtable1}>
                  <tr>
        ...
        <EinvoiceTable item={InvoiceDetailsList} />
      </div>
    );
  }
}
